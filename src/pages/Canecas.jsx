    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <p
            id="descricao-capacaneca"
            className="text-lg md:text-xl text-gray-300 max-w-xl mx-auto mb-8"
          >
            SUA CANECA COMO DESEJAR
            Oferecemos uma variedade de canecas personalizadas para todas as ocasiões.
            Nossas canecas são perfeitas para presentear amigos e familiares, ou para uso pessoal.
            Com designs exclusivos e altíssima qualidade, 
            nossas canecas são feitas para durar e impressionar.
          </p>
